...
class word2vec_add_bigru(nn.Module):
    def __init__(self, num_class, d_model, num_layer, input_size, hidden_size):
        ...
        self.transformerencoder = nn.TransformerEncoder(
            nn.TransformerEncoderLayer(d_model=768, nhead=6, batch_first=True,dropout=0.2), #原来是nhead=6
            num_layers=6)
...
if __name__ == '__main__':
    EPOCHS = 50
    filepath_train = 'D:/PycharmProjects/pythonProject/Ming21/只能合约/词嵌入训练/train_udrequ_shuffle_2048.csv'

    filepath_val = 'D:/PycharmProjects/pythonProject/Ming21/只能合约/词嵌入训练/val_udrequ_shuffle_2048.csv'
